...
public class Job5 {
    public static void main(String[] args) throws Exception {
        ...
        //收集迟到数据的集合
        OutputTag<Tuple2<String, Long>> outputTag = new OutputTag<Tuple2<String, Long>>("lateData"){};

        //数据处理
        SingleOutputStreamOperator<String> result = source.flatMap(new ExtractMapFunction())
